...
class PYROSIM:
	...
	def Send_Sensor_Neuron(self, neuronID=0, sensorID=0, sensorValueIndex=0, tau=1.0 ):
        ...
        def Send_Synapse(self, sourceNeuronID = 0 , targetNeuronID = 0 , weight = 0.0 , finalWeight = 0.0, transitionTime = 0):
	        ...
	        outputString = 'Synapse'
                ...
                outputString = outputString + ' ' + str(finalWeight)

                outputString = outputString + ' ' + str(int(transitionTime))
	...
	def Send_Vestibular_Sensor(self, sensorID=0, objectID = 0):
		...
		# dataFromSimulator = self.simulator.stdout.read()
